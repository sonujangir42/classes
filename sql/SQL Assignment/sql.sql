...
select e.employee_id,e.last_name,e.salary from employees where salary > (select avg(salary) from employees) and e.department_id in (select distinct department_id from employees where e.last_name like '%u%');
